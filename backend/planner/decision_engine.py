...
- SECURITY VERIFICATION & CLOUDFLARE TURNSTILE: When a "Verify you are human", Cloudflare Turnstile, or security challenge appears, output action "click" with target "Verify you are human" or "input[type='checkbox']". The agent engine will automatically handle and click Turnstile/Cloudflare checkboxes across iframes. NEVER return "need_human_input" or "blocked" for Cloudflare / Turnstile human verification challenges!
