...
{
  "action": "click | type | navigate | scroll | wait | upload | finish | blocked | wallet_popup",
  "target": "visible text or description of the element to act on (empty for navigate/scroll/wait/finish)",
  "value": "text to type, or URL to navigate to, or scroll direction (empty otherwise)",
